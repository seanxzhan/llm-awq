...
python -m awq.entry --model_path openvla/openvla-7b \
    ...
    --run_awq --dump_awq awq_cache/openvla-lora_2bit.pt \
    --calib_data openvla
...
python -m awq.entry --model_path openvla/openvla-7b \
    ...
    --dataset_name bridge_orig \
    --lora_pt /mnt/align4_drive/rachelm8/llm-awq/finetuned/finetuned.pt \
    --expname lora-salient-2bit
# evaluation on bridge_orig with awq pseudo quant on finetuned weights
python -m awq.entry --model_path openvla/openvla-7b \
    --tasks bridge_orig \
    --w_bit 2 --q_group_size 128 \
    --q_backend fake \
    --load_awq awq_cache/openvla-lora_2bit.pt \
    --batch_size 1 \
    --eval_root_dir eval \
    --data_root_dir /mnt/align4_drive/rachelm8/tinyml \
    --dataset_name bridge_orig \
    --lora_pt /mnt/align4_drive/rachelm8/llm-awq/finetuned/finetuned.pt \
    --expname lora-awq-2bit
